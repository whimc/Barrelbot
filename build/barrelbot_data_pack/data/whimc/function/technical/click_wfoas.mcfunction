...
execute if data storage whimc:storage {ClickedItem: {components: {"minecraft:custom_data": {whimc_puzzle_wand:true}}}} run function whimc:barrelbot/editor/edit_wand/click
