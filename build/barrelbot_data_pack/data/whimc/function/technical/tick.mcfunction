...
execute if score $propagate_active whimc.dummy matches 1 run function whimc:barrelbot/puzzle_instance/propagate_tick
execute if score $clone_paste_active whimc.dummy matches 1 run function whimc:barrelbot/clone_paste/tick
