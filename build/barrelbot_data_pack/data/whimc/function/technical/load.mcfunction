...
data modify storage whimc:const text.barrelbot.start set value {text:"Run",color:"#55FF55",bold:true}
data modify storage whimc:const text.barrelbot.stop set value {text:"Reset",color:"#FF5555",bold:true}
...
execute unless data storage whimc:storage puzzle_instances run data modify storage whimc:storage puzzle_instances set value []
scoreboard players set #16 whimc.const 16
