...
execute unless entity @s[tag=whimc.barrelbot.locked] run data modify block ~ ~ ~ components."minecraft:lock" set value {predicates:{"minecraft:custom_name":{text:"_LOCKTYPE: RUNNING_"}}}
