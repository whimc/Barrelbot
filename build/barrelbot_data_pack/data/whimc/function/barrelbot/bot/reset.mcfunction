...
execute as @s[tag=!whimc.dispenser_bot] at @s run item replace entity @s container.0 with black_stained_glass_pane[minecraft:custom_model_data={floats:[130000.0f]}]
execute as @s[tag=whimc.dispenser_bot] at @s run item replace entity @s container.0 with red_stained_glass_pane[minecraft:custom_model_data={floats:[130000.0f]}]
