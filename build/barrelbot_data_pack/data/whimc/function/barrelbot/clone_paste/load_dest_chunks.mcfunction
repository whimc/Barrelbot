function whimc:barrelbot/clone_paste/compute_dest_bounds
...
scoreboard players operation $chunk_min_x whimc.dummy = $chunk_x whimc.dummy
scoreboard players operation $chunk_min_z whimc.dummy = $chunk_z whimc.dummy
...
function whimc:barrelbot/puzzle_instance/block_to_chunk
scoreboard players operation $chunk_max_x whimc.dummy = $chunk_x whimc.dummy
scoreboard players operation $chunk_max_z whimc.dummy = $chunk_z whimc.dummy
...
scoreboard players set $clone_paste_wait whimc.dummy 20
scoreboard players set $clone_paste_loading whimc.dummy 1
