...
data merge entity @s {see_through:true, brightness: {sky: 15, block: 15}, background: 855618304, transformation: {left_rotation: {angle: 1.570796326f, axis: [1.0f, 0.0f, 0.0f]}}}
