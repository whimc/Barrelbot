execute on vehicle on passengers as @s[type=minecraft:interaction,tag=whimc.editor_click] if data entity @s interaction on target run function whimc:barrelbot/editor/edit_wand/edit_mode/click
