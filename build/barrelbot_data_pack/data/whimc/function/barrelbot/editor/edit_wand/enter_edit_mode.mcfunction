...
ride @s dismount
summon item_display ~ ~0.60001 ~ {Tags: ["whimc.editor_base", "whimc.editor_base.init"], Passengers: [{id: "minecraft:interaction", Tags: ["whimc.editor_click"], width: 2.0f, height: 1.15f}]}
