...
scoreboard players operation $chunk_x whimc.dummy /= #16 whimc.const
scoreboard players operation $chunk_z whimc.dummy /= #16 whimc.const
scoreboard players operation $rem whimc.dummy = $block_x whimc.dummy
scoreboard players operation $rem whimc.dummy %= #16 whimc.const
