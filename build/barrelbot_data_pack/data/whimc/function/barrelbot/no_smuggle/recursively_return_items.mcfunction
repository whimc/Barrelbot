...
execute unless data storage whimc:storage Inventory[0].components."minecraft:custom_data".barrelbot.puzzle_item if data storage whimc:storage Inventory[0].tag.barrelbot.puzzle_item run function whimc:barrelbot/no_smuggle/return_item
