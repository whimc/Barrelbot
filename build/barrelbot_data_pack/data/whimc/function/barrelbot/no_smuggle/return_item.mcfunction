...
execute unless score $temp whimc.barrelbot.bot_id matches 1.. run execute store result score $temp whimc.barrelbot.bot_id run data get storage whimc:storage Inventory[0].tag.barrelbot.instructor_id
