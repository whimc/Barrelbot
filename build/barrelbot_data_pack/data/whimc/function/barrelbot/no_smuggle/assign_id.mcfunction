...
data modify storage whimc:storage Item set from storage whimc:storage Inventory[{components:{"minecraft:custom_data":{barrelbot:{puzzle_item:1b}}}}]
...
function whimc:barrelbot/no_smuggle/ensure_bounding_box
