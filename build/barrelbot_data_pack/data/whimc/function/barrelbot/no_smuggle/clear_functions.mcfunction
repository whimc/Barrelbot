execute if data storage whimc:storage Inventory[0].components."minecraft:custom_data".barrelbot.puzzle_item run function whimc:barrelbot/no_smuggle/clear_functions/nested_execute_0
