...
function whimc:barrelbot/instructions/grab_cake/execute/nested_macro_0 with storage whimc:macro
...
execute if score $dropped_block whimc.dummy matches 1 run function whimc:barrelbot/instructions/grab_cake/execute/nested_execute_0
