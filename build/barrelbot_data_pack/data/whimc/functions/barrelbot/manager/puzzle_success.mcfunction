...
tellraw @a ["", {"text": "[Barrelbot] ", "bold": true, "color": "gray"}, {"selector": "@a[tag=whimc.success_haver]", "color": "gold"}, " has completed ", {"nbt": "puzzle_name", "storage": "whimc:storage", "color": "green"}, "!"]
