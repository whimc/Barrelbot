#> whimc:barrelbot/editor/outline/spawn/min_y

scoreboard players operation @s whimc.barrelbot.puzzle_id = $temp whimc.barrelbot.puzzle_id

tag @s add whimc.editor_outline
tag @s add whimc.editor_outline.min_y
data merge entity @s {see_through:1b,brightness:{sky:15,block:15},background:-2145286754,transformation:{left_rotation:{angle:1.570796326f,axis:[1.0f,0.0f,0.0f]}}}
