#> whimc:barrelbot/manager/setup_marker
#   Sets up the initial bounding box for the puzzle
...
execute store result entity @s data.bounding_box.min_y int 1 run scoreboard players get $marker_y whimc.dummy
...
execute store result entity @s data.bounding_box.max_y int 1 run scoreboard players add $marker_y whimc.dummy 2
