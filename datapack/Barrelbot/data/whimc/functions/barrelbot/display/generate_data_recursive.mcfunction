#> whimc:barrelbot/display/generate_data_recursive
#   Creates the data for a singular item

#Create base data structure
data modify storage whimc:storage current_display set value {transformation:{translation:[0f,0f,0f]},item:{id:"minecraft:barrier",Count:1b}}

#Get position from slot
...
#Append to storage and continue loop if there are more items to do
