...
execute if block ~ ~ ~ #minecraft:shulker_boxes as @e[type=item_display,tag=whimc.instructor,dx=0,dy=0,dz=0,limit=1] run function whimc:barrelbot/editor/edit_wand/instructor_found