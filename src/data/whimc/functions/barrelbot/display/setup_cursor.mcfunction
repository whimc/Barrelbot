#> whimc:barrelbot/display/setup_cursor
#   Sets up the cursor display entity
...
data merge entity @s {billboard:"center",transformation:{scale:[0.26f,0.26f,0f],translation:[100000f,0.225f,0.01f],left_rotation:{angle:3.141592f,axis:[0f, 1f, 0f]}},item_display:"gui",brightness:{sky:15,block:15}}