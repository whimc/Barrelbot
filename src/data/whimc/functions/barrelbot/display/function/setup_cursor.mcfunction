#> whimc:barrelbot/display/function/setup_cursor
...
data merge entity @s {billboard:"center",transformation:{scale:[0.26f,0.26f,0f],translation:[-0.912f,0.225f,0.01f],left_rotation:{angle:3.141592f,axis:[0f, 1f, 0f]}},item_display:"gui"}