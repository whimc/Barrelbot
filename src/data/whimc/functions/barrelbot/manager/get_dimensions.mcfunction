#> whimc:barrelbot/manager/get_dimensions
#   Gets the manager's bounding box dimensions into storage for use in macros
...
#Get destination data into storage as well
